...
@listableObjectComponent('PublicationSearchResult', ViewMode.ListElement, Context.Any, 'shareok')
@listableObjectComponent(ItemSearchResult, ViewMode.ListElement, Context.Any, 'shareok')
@Component({
