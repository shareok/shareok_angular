 ...
 */
@Component({
  selector: 'ds-metadata-csvalues',
  styleUrls: ['./metadata-csvalues.component.scss'],
  templateUrl: './metadata-csvalues.component.html'
})
export class MetadataCSValuesComponent implements OnChanges {
